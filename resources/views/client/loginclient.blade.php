    ...
    <div class="main-content fl-right">
        <div class="form-tt">
            ...
            <form action="#" method="post" name="dang-ky">
                ...
                <input type="checkbox" id="checkbox" name="checkbox"><label class="checkbox-text">Nhớ đăng nhập lần
                    sau</label>
                <input type="submit" name="submit" value="Đăng nhập" />
                
                <a class="logoutClient" href="{{ route('logoutClient') }}">Quên mật khẩu</a>
                <a class="logoutClient" href="{{ route('registerClient') }}">Đăng ký</a>
            </form>
