        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('admin/posts/storeCat') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="name">Tên danh mục</label>
                                <input class="form-control slug" type="text" name="name" id="name" >
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="slug_postCat" id="slug_catPost">
                                @error('slug_postCat')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
