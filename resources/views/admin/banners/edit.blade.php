                ...
                <form action="{{ route('banner.update',$banners->id) }}" method="POST"enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $banners->name }}" id="title">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="product_thumb" class="form-control-file" id="image_path">
                            <img style="width:200px" src="{{ asset($banners->product_thumb) }}" alt="">
                            @error('product_thumb')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="content_desc" value="{{ $banners->content_desc }}" class="form-control" id="description">
                            @error('content_desc')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="link" value="{{ $banners->link }}" class="form-control" id="link">
                            @error('link')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
